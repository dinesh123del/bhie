...
export class SubscriptionPlanService {
  static getPlan(planCode: string): PlanConfig | null {
  ...
  static getPlanByPrice(price: number, cycle: 'monthly' | 'yearly' = 'monthly'): PlanConfig | null {
  ...
  static formatPlanMessage(): string {
  ...
  static formatPlanConfirmation(plan: PlanConfig, cycle: 'monthly' | 'yearly'): string {
  ...
  static isValidPlan(planCode: string): boolean {
