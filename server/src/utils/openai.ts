...
let openaiClient: OpenAI | null = env.OPENAI_API_KEY
  ? new OpenAI({
 ...
 */
export async function callOpenAI(prompt: string, model: 'gpt-4o-mini' | 'gpt-4o-2024-08-06' = 'gpt-4o-mini'): Promise<AIResponse> {
  try {
 ...
 */
export function parseAIResponse(response: AIResponse): any {
