...
router.get('/metrics/:businessId?', asyncHandler(async (req: AuthRequest, res: Response) => {
...
// Get alert history
router.get('/alerts/:businessId?', asyncHandler(async (req: AuthRequest, res: Response) => {
  const { businessId } = req.params;
  const userId = req.user?.userId;
...
// Get event history
router.get('/events/:businessId?', asyncHandler(async (req: AuthRequest, res: Response) => {
  const { businessId } = req.params;
  const userId = req.user?.userId;
