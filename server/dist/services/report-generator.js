...
export class ReportGenerator {
    static async createMonthly(businessId, options = {}) {
    ...
    static async generateInsightsPDF(businessId) {
        const business = await Business.findById(businessId);
...
ReportGenerator.REPORTS_DIR = path.join(process.cwd(), 'uploads', 'reports');
