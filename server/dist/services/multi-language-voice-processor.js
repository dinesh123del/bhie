...
export class MultiLanguageVoiceProcessor {
     ...
     */
    async uploadToAssemblyAI(audioBuffer, mimeType) {
     ...
     */
    async parseTransaction(transcription) {
        ...
        const isExpense = expenseKeywords.some(keyword => text.toLowerCase().includes(keyword.toLowerCase()));
     ...
     */
    extractDescription(text, language, type) {
