...
export class BusinessSummary {
    static async get(businessId, period = 'month') {
        const now = new Date();
        let startDate;
        switch (period) {
            case 'month':
    ...
    static async calculateHealthScore(income, expenses, businessId) {
    ...
    static async calculateTrend(businessId) {
        const now = new Date();
    ...
    static async getMonthlyRevenue(businessId, start, end) {
    ...
    static async getYearlyComparison(businessId) {
        const now = new Date();
    ...
    static async getPeriodRevenue(businessId, start, end) {
        const result = await Record.aggregate([
            {
                $match: {
                    businessId,
