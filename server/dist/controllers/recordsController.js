...
export const recordsController = {
    ...
    create: asyncHandler(async (req, res) => {
        ...
        await import('../utils/generateAlerts.js').then(({ generateAlerts }) => generateAlerts({
            userId: authUser.userId,
            action: 'record',
            record: {
                type: req.body.type,
    ...
    update: asyncHandler(async (req, res) => {
        ...
        const record = await Record.findOneAndUpdate({ _id: req.params.id, userId: user.userId }, req.body, { new: true, runValidators: true });
        if (!record) {
