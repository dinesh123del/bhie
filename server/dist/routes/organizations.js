 ...
 * @access  Private (Organization Member)
 */
router.get('/:id/settings', resolveTenant, requireTenant, asyncHandler(async (req, res) => {
    res.json({
        success: true,
        data: {
 ...
 * @access  Private (Admin, Owner)
 */
router.patch('/:id/settings', resolveTenant, requireTenant, requireRoleLevel('admin'), asyncHandler(async (req, res) => {
