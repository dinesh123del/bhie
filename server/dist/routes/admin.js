...
// ─── VERIFY ACCESS CODE ──────────────────────────────────────
router.post('/verify-code', authenticateToken, checkAdmin, asyncHandler(async (req, res) => {
    const { code } = req.body;
    if (!code) {
...
// ─── CHANGE ACCESS CODE ──────────────────────────────────────
router.patch('/access-code', authenticateToken, checkAdmin, asyncHandler(async (req, res) => {
...
// ─── ADD NEW ADMIN ───────────────────────────────────────────
router.post('/add-admin', authenticateToken, checkAdmin, asyncHandler(async (req, res) => {
...
// ─── REMOVE ADMIN ACCESS ────────────────────────────────────
router.post('/remove-admin', authenticateToken, checkAdmin, asyncHandler(async (req, res) => {
...
// ─── LIST ALL ADMINS ─────────────────────────────────────────
router.get('/admins', authenticateToken, checkAdmin, asyncHandler(async (req, res) => {
...
router.post('/check-admin', asyncHandler(async (req, res) => {
    const { email, password } = req.body;
    if (!email || !password) {
