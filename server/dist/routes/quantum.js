...
router.post('/optimize/portfolio', asyncHandler(async (req, res) => {
...
router.post('/optimize/schedule', asyncHandler(async (req, res) => {
    const userId = req.user?.userId;
...
router.post('/ml/predict', asyncHandler(async (req, res) => {
    const userId = req.user?.userId;
...
router.post('/crypto/keys', asyncHandler(async (req, res) => {
    const userId = req.user?.userId;
    if (!userId) {
        return res.status(401).json({ error: 'User not authenticated' });
    }
...
router.post('/optimize/batch', asyncHandler(async (req, res) => {
    const userId = req.user?.userId;
