...
router.get('/context/:businessId?', asyncHandler(async (req, res) => {
...
router.get('/tasks/:businessId?', asyncHandler(async (req, res) => {
    const { businessId } = req.params;
    const userId = req.user?.userId;
...
router.post('/trigger/:agentName/:businessId?', asyncHandler(async (req, res) => {
    ...
    const capabilities = [
        {
            ...
            description: 'Review your financial performance and get strategic recommendations',
        ...
        },
        {
            ...
            description: 'Find new opportunities to grow your business revenue',
        ...
        },
        {
            ...
            description: 'Discover ways to reduce expenses and improve profitability',
        ...
        },
        {
            ...
            description: 'Understand customer patterns and improve satisfaction',
            triggers: ['transaction', 'metrics-update'],
            category: 'analytics',
            frequency: 'daily'
        },
        {
            ...
            description: 'Find opportunities to streamline your business operations',
            triggers: ['transaction', 'metrics-update'],
            category: 'automation',
            frequency: 'weekly'
        }
...
router.get('/performance/:businessId?', asyncHandler(async (req, res) => {
    const { businessId } = req.params;
    const userId = req.user?.userId;
    if (!userId) {
        return res.status(401).json({ error: 'User not authenticated' });
