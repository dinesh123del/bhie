          ...
          {step === 'email' ? (
            <form className="space-y-6" onSubmit={handleSendOtp}>
              ...
              <motion.button
                ...
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
              >
            ...
            <form className="space-y-6" onSubmit={handleVerifyOtp}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/8 border border-white/20 rounded-xl text-white text-center text-2xl placeholder-gray-400 focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-500/20 transition-all tracking-widest"
                  placeholder="000000"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-2 text-indigo-400 hover:text-indigo-300 font-medium transition-colors"
              >
                Change Email
              </button>
            </form>
