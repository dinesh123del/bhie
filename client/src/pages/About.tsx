      ...
      <section className="px-4 pb-16 pt-12 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            ...
            >
              BHIE turns messy lists of bills and numbers into a clear plan for you to grow.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="rounded-[44px] bg-slate-950/80 p-8 sm:p-16">
            <div className="grid gap-16 lg:grid-cols-[0.8fr_1.2fr]">
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-400">BHIE is here to make business simple for everyone.</p>
              </div>
