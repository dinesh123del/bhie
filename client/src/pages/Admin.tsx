                    ...
                    <tbody className="divide-y divide-white/5 text-left">
                      {users.map(u => (
                        <tr key={u._id} className="hover:bg-white/[0.01]">
                          ...
                          <td className="px-8 py-6">
                            <span className={`px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest border ${u.plan === 'premium' ? 'bg-purple-500/10 border-purple-500/40 text-purple-400' :
