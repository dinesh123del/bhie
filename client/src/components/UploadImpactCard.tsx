      ...
      <div className="flex h-full flex-col gap-6">
        <div className="space-y-3">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-7 text-ink-300">
              Every upload should feel useful immediately. BIZ PLUS shows what was extracted and how it changes your business picture.
            </p>
          </div>
        </div>
        ...
        {latestUpload ? (
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-white">
                    Confirm the extracted category and keep daily uploads flowing so BIZ PLUS can detect cost and profit patterns faster.
                  </p>
                </div>
          ...
          <div className="mt-auto rounded-[1.5rem] border border-dashed border-white/12 bg-white/[0.03] px-5 py-6">
            ...
            <p className="mt-2 text-sm leading-6 text-ink-300">
              Upload a bill, invoice, or statement and BIZ PLUS will instantly show extracted data and business impact here.
            </p>
          </div>
        )}
      </div>
