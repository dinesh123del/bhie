...
const AERASavings = ({ records = [] }: { records?: Record[] }) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[22px] font-black tracking-tight text-white italic">AERA Price Whisperer</p>
            </div>
          </div>
          <motion.div 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
                ...
                <p className="text-[16px] font-medium text-white/40 leading-relaxed max-w-sm">
                   AERA has compared your spending against <span className="text-white/70 font-black">1.2M global benchmarks.</span> These autonomous savings are achievable without any action on your part.
                </p>
            </div>
           ...
           {activeNegotiation && (
             ...
             >
                <div className="flex items-center gap-4 mb-4">
                   ...
                   <span className="text-[14px] font-black text-indigo-400 uppercase tracking-widest">AERA Negotiation Protocol (Live)</span>
                </div>
                <p className="text-[17px] font-black text-white italic leading-relaxed">
                   "AERA is contacting {activeNegotiation}'s billing department with global pricing benchmarks. We will handle the thread and update you when the ${Math.round(opportunities.find(o => o.vendor === activeNegotiation)?.potentialSavings || 0)} credit is applied."
                </p>
                <button 
