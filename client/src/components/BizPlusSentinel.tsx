      ...
      <div className="relative z-10 flex flex-col gap-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[18px] font-black tracking-tight text-white">BIZ PLUS Sentinel v3.0</p>
            </div>
          </div>
        ...
        <div className="apple-card p-6 bg-indigo-500/[0.03] border-indigo-500/10 mt-2">
           ...
           <p className="mt-6 text-[12px] font-medium text-white/40 leading-relaxed border-t border-white/5 pt-4">
              <span className="text-white/60 font-black">BIZ PLUS Insight:</span> {benchmarks.recommendation}
           </p>
        </div>
      </div>
    </motion.div>
...
export default BizPlusSentinel;
