  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        onDrop={handleDrop}
        className={`relative p-12 rounded-2xl border-2 border-dashed transition-all cursor-pointer ${dragActive
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`text-xs font-semibold px-2 py-1 rounded ${file.status === 'completed'
